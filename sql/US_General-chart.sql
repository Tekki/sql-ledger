...
--
INSERT INTO defaults (fldname, fldvalue) VALUES ('inventory_accno_id', (SELECT id FROM chart WHERE accno = '1510'));
...
--
INSERT INTO curr (rn, curr, precision) VALUES (1,'USD',2);
INSERT INTO curr (rn, curr, precision) VALUES (2,'CAD',2);
