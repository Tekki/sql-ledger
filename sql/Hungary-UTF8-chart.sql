...
-- Magyar főkönyvi számlák, amelyek csak példaként szolgálnak
--
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('3110','Vevők','A','A','AR','311');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('3111','Külföldi vevők','A','A','AR','311');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4660','Visszaigényelhető ÁFA 25%','A','L','AP_tax:IC_taxpart:IC_taxservice','466');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4661','Visszaigényelhető ÁFA 12%','A','L','AP_tax:IC_taxpart:IC_taxservice','466');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4662','Visszaigényelhető ÁFA 5%','A','L','AP_tax:IC_taxpart:IC_taxservice','466');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4663','Visszaigényelhető ÁFA adómentes','A','L','AP_tax:IC_taxpart:IC_taxservice','466');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4670','Fizetendő ÁFA 25%','A','L','AR_tax:IC_taxpart:IC_taxservice','467');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4671','Fizetendő ÁFA 15%','A','L','AR_tax:IC_taxpart:IC_taxservice','467');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4672','Fizetendő ÁFA 5%','A','L','AR_tax:IC_taxpart:IC_taxservice','467');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno) VALUES ('4673','Fizetendő ÁFA adómentes','A','L','AR_tax:IC_taxpart:IC_taxservice','467');
...
--
INSERT INTO curr (rn, curr, prec) VALUES (1,'HUF',0);
