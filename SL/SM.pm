...
# © 2009-2026 Tekki (Rolf Stöckli)  https://github.com/Tekki/sql-ledger
#
#======================================================================
#
...
L<SL::SM> contains the module for reposting/deleting invoices.

=head1 FUNCTIONS

L<SL::SM> implements the following functions:

=head2 dberror

  SM::dberror($form, $query, $userspath);
