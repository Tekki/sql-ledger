...
sub num2text {
  ...
  my @numblock = map { scalar reverse } reverse(abs $amount) =~ /(.{1,3})/g;
...
Num2Text - Default code for the check package

=head1 DESCRIPTION

L<SL::Num2Text> contains the default code for the check package.

=head1 FUNCTIONS

L<SL::Num2Text> implements the following functions:

=head2 format_ten

  Num2Text->format_ten($amount);
