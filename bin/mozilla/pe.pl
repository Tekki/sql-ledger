...
<table width=100%>
  ...
  <tr valign=top>
	...
	<tr>
	  <th></th>
  	  <td><input name=summary type=radio class=radio value=0 checked> |.$locale->text('Summary').qq|
  	  <input name=summary type=radio class=radio value=1> |.$locale->text('Detail').qq|
  	  </td>
  	</tr>
      </table>
    </td>
