...
L<bin::mozilla::vr> contains functions for voucher/batch register.
...
L<bin::mozilla::vr> implements the following functions:

=head2 add_batch

=head2 add_general_ledger_batch

=head2 add_payable_batch

=head2 add_payment_batch

=head2 add_payment_reversal_batch

=head2 add_payments_batch
...
=head2 edit_payment_reversal

=head2 general_ledger_batch
...
=head2 payment_reversal_batch

=head2 payments_batch
