...
subtest 'Subroutines' => sub {
  my @subs = (
    ...
    'next_item',                  'new_number',
    'parts_subtotal',             'preview',
    'previous_item',              'print_',
    'requirements',               'requirements_report',
    'resource_planning',          'restock_assemblies',
    'save',                       'save_as_new',
    'search',                     'search_transfer',
    'select_name',                'so_requirements',
    'so_requirements_report',     'stock_adjustment',
    'stock_assembly',             'supply_demand',
    'supply_demand_report',       'transfer',
    'transfer_list',              'transfer_report',
    'update',                     'upload_image',
    'upload_imagefile',           'vendor_row',
    '_searchitems_title',
  );
