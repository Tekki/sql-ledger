...
can_ok $obj, (
  ...
  'json',              'params_are',     'params_are_empty', 'post_ok',       'press_button_ok',
  'remove_locks_ok',   'rows_are',       'set_action_ok',    'set_form',      'set_params_ok',
  'store_ok',          'test_stamp',     'texts_are',        'update_row_ok', 'user_login_ok',
  'DESTROY',
