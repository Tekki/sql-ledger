...
can_ok $obj, (
  ...
  'download_ok',  'download_is',           'elements_exist', 'elements_exist_not', 'follow_link_ok',
  'form_exists',  'form_fields_exist_not', 'form_fields_exist', 'form_hidden_exist', 'form_params',
  'get_download_ok',  'get_ok',            'headers',           'json',              'params_are',
  'params_are_empty', 'post_ok',           'press_button_ok',   'remove_locks_ok',   'rows_are',
