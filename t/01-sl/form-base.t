...
can_ok $obj,
  ...
  'print_button',          'print_button_table', 'process_template',  'process_tex',
  'qr_variables',          'quote',              'redirect',          'redo_rows',
  'report_defaults',       'remove_locks',       'report_level',      'reports',
  'rerun_latex',           'reset_shipped',      'retrieve_form',     'retrieve_report',
  'round_amount',          'run_latex',          'save_exchangerate', 'save_form',
  'save_intnotes',         'save_recurring',     'save_reference',    'save_report',
  'save_status',           'search_defaults',    'select_option',     'set_cookie',
  'sha256_hex',            'sort_column_index',  'sort_columns',      'sort_order',
  'split_date',            'timegm',             'timelocal',         'unescape',
  'unquote',               'update_balance',     'update_defaults',   'update_exchangerate',
  'update_status',         'valid_date',         'weekday',           'workingday',
  );
