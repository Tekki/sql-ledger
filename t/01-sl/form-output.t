...
subtest 'Buttons' => sub {
  ...
  my %button = (
    ...
    'Value 4' => {ndx => 4, key => 'D', value => 'Value IV', action => 'value_9'},
    'Value 5' => {ndx => 5, key => 'E', value => 'Value 5',  onclick => 'do()'},
  );
...
<button class="submit noprint" type="submit" name="action" value="value_9" accesskey="D" title="Value IV [D]">Value IV</button>
<button class="submit noprint" type="button" name="action" value="value_5" accesskey="E" title="Value 5 [E]" onclick="do()">Value 5</button>|;
