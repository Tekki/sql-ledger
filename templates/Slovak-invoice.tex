...
\begin{tabularx}{\textwidth}{>{\hsize=0.4cm\centering}X@{\ }
  ...
  \textbf{Regál} & \textbf{Množ.} & \textbf{MJ} & 
...
\begin{tabularx}{\textwidth}{>{\hsize=0.4cm\centering}X@{\ }
  ...
  \centering\textbf{pol} & \raggedright\textbf{Skup.} & \raggedright\textbf{Èíslo} & \raggedright\textbf{Popis} &
  \centering\textbf{Regál} & \raggedleft\textbf{Množ} & \centering\textbf{MJ} & 
  \raggedleft\textbf{Cena bez DPH} & \raggedleft\textbf{Suma bez DPH} & \raggedright\textbf{DPH\%} & 
  \raggedleft\textbf{Suma DPH} & \raggedleft\textbf{Suma}
  \cr
<%foreach number%>
